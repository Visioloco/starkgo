...
import 'schema/reportepago_record.dart';
import 'schema/starlinks_record.dart';
...
export 'schema/reportepago_record.dart';
export 'schema/starlinks_record.dart';
...
/// Functions to query ReportepagoRecords (as a Stream and as a Future).
Future<int> queryReportepagoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ReportepagoRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ReportepagoRecord>> queryReportepagoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ReportepagoRecord.collection,
      ReportepagoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ReportepagoRecord>> queryReportepagoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query StarlinksRecords (as a Stream and as a Future).
Future<int> queryStarlinksRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      StarlinksRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<StarlinksRecord>> queryStarlinksRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      StarlinksRecord.collection,
      StarlinksRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<StarlinksRecord>> queryStarlinksRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future updateUserDocument({String? email}) async {
  await currentUserDocument?.reference.update(createUserRecordData(email: email));
}
